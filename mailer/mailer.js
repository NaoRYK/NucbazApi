...
var sendEmail = function (to, code) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error al enviar el correo electronico: ", error_1);
                return [3 /*break*/, 4];
